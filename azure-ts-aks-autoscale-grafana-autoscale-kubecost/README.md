...
1. Launch
   ...
   ```bash
    ...
    View in Browser (Ctrl+O): https://app.pulumi.com/tushar-pulumi-corp/azure-ts-aks-autoscale-grafana-autoscale-kubecost/dev/updates/114

        Type                                                   Name                                                   Status              Info
    +   pulumi:pulumi:Stack                                    azure-ts-aks-autoscale-grafana-autoscale-kubecost-dev  created (349s)      2 messages
    +   ├─ azuread:index:Application                           demo2-aad-application                                  created (3s)        
    +   │  └─ azuread:index:ServicePrincipal                   demo2-adsp                                             created (3s)        
    +   │     └─ azuread:index:ServicePrincipalPassword        demo2-adsp-password                                    created (5s)        
    +   ├─ tls:index:PrivateKey                                demo2-ssh-private-key                                  created (3s)        
    ...
    +   │     ├─ azure-native:network:Subnet                   demo2-publicSubnet2                                    created (3s)        
    +   │     │  └─ azure-native:network:Subnet                demo2-privateSubnet5                                   created (4s)        
    +   │     ├─ azure-native:network:Subnet                   demo2-publicSubnet1                                    created (4s)        
    +   │     │  └─ azure-native:network:Subnet                demo2-privateSubnet4                                   created (4s)        
    +   │     ├─ azure-native:network:Subnet                   demo2-publicSubnet0                                    created (4s)        
    +   │     │  └─ azure-native:network:Subnet                demo2-privateSubnet3                                   created (4s)        
    +   │     └─ azure-native:containerservice:ManagedCluster  demo2-managedcluster                                   created (188s)      
    +   │        └─ azure-native:containerservice:AgentPool    demo2-userAgentPool                                    created (125s)      
    +   ├─ pulumi:providers:kubernetes                         demo2-k8sprovider                                      created (0.73s)     
    +   ├─ kubernetes:core/v1:Namespace                        demo2-metric-ns                                        created (0.62s)     
    +   │  └─ kubernetes:helm.sh/v3:Release                    demo2-k8smonitoringhelmr                               created (54s)       
    +   └─ kubernetes:core/v1:Namespace                        demo2-kubecost-ns                                      created (0.70s)     
    +      └─ kubernetes:helm.sh/v3:Release                    demo2-kubecosthelmr                                    created (70s)       

    Diagnostics:
    pulumi:pulumi:Stack (azure-ts-aks-autoscale-grafana-autoscale-kubecost-dev):
        (node:62231) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
        (Use `node --trace-deprecation ...` to show where the warning was created)

    Outputs:
        azuread_application_display_name: "demo2-aad-application"
        azuread_application_id          : "/applications/083927f1-192a-4363-9a32-344174416662"
        azuread_service_principal_name  : "demo2-aad-application"
        cluster_k8s_version             : "1.26.10"
        cluster_name                    : "demo2-managedcluster41088388"
        helm_chart_kubecost             : "demo2-kubecosthelmr-adb8623b"
        helm_chart_prometheus_metrics   : "demo2-k8smonitoringhelmr-b241d796"
        kubeconfig                      : [secret]
        namespace_kubecost              : "demo2-kubecost-ns-3a3bd582"
        namespace_metrics               : "demo2-metric-ns-f2e3c4f3"
        ...
        resource_group_name             : "demo2-rgbb77ca19"
        storage_account_name            : "demo2saf6e5868d"
        user_agentpool_name             : "demo2spot"
        vnet_name                       : "demo2-vnetebac9d22"
