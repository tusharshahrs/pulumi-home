...
//const foobarcrd  = new k8s.apiextensions.v1beta1.CustomResourceDefinition(`${my_name}-foobarcrd`, {
    ...
    { provider: k8sProvider, dependsOn: [namespace, mycluster]}); // Comment out this line after the first run when you are trying to create the issue.
   // {dependsOn: [namespace, mycluster]});         //Uncomment the code on this line and run pulumi up and select yes to trigger the error
