...
[azure-ts-sqlserver-servervulnerabilityassessment](azure-ts-sqlserver-servervulnerabilityassessment) azure sql server with azure defender turned on at the *subscription* level.  Have to run *pulumi up* multiple times to get it to work. Investigating this issue. | [![AZURE typescript](https://img.shields.io/badge/AZURE-TYPESCRIPT-blue)](https://www.pulumi.com/docs/reference/pkg/azure-native/) |
