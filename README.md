...
[aws-classic-ts-ec2-instance-with-ebs-volume](aws-classic-ts-ec2-instance-with-ebs-volume)| aws vpc with awsx package, ec2 instance with encrypted storage and 2 ebs volumes added that are encrypted
