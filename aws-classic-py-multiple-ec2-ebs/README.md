# AWS  VPC via AWSX package in Python along with EC2 and EBS Volumes

AWS vpc built with [awsx package](https://www.pulumi.com/registry/packages/awsx/installation-configuration/) and multiple ec2 with optional ebs volumes.
